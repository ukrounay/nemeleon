...
<div id="nav-ph"></div>
<div id="nav-bg" class="shadow"></div>
...
<article>
    ...
    <section class="shadow">
        ...
        <header>
            <div style="position: relative; width: 100%; padding-top: 40%; overflow: hidden;">
                <div style="position: absolute; top: 0; left: 0; bottom: 0; right: 0;">
                    <img src="<?php echo $article['indeximg']; ?>" style="object-position: 50% 50%; object-fit: cover; width: 100%; height: 100%"></img>
                </div>
            </div>
    ...
    <aside>
        <div class="float-content-table fade-shadow">
            <h2>Зміст</h2>
            <div id="dot-cont"></div>
        </div>
    </aside>
