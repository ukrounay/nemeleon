...
<div id="site">
    ...
    <nav id="navigation-top">
        ...
        <div id="linkbox">
            ...
            <div class="hover-drop hide1" onmouseover="dropboxShow(0)" onmouseout="dropboxHide(0)">
                ...
                <div class="dropbox shadow">
                    <a class="menulink" href="javascript:void(0);">Допомогти</span></a>
        ...
        <div id="iconbox">
            ...
            <div id="menu-btn" onclick="hoverNavToggle()">
                <div class="bars">
                    <div class="bar"></div>
                    <div class="bar"></div>
                </div>
    ...
    <section id="intro" class="shadow">
        ...
        <div id="intro-content">
            <div id="introtext">
                <h1>Читай, що хочеш!</h1>
                <p>
                    Оригінальні підбірки - статті, фото, пости та дописи, об'єднані спільною темою<br>
                    <a class="button dark-btn" href="search">Всі підбірки</a>
                </p>
            </div>
            <div id="introimg">
                <img src="css/img/mask.svg"></img>
            </div>
        </div>
    </section>
    ...
    <div class="divide-line blue-white"></div>
    <section id="join">
        <div id="join-content">
            <div id="jointext">
