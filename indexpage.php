<div id="site">
    ...
    <nav id="navigation-top">
        ...
        <div id="linkbox">
            ...
            <a class="menulink hide2" href="#">Читати</a>

            <div class="hover-drop hide1" onmouseover="dropboxShow(0)" onmouseout="dropboxHide(0)">
                <a class="menulink" href="#">Проект <i class="fa-solid fa-angle-down"></i></a>
                <div class="dropbox shadow">
                    <a class="menulink" href="#">Про нас</a>
                    <a class="menulink" href="#">Допомогти</a>
                    <a class="menulink" href="#">Підтримати</a>
                </div>
            </div>
            
            <a class="menulink hide3" href="#">Контакти</a>
